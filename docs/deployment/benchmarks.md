...
> **Status: harness + placeholders, not measured figures.** Every number in the
> results tables below is a **placeholder marked `TO BE MEASURED`**. Ai-Guard
> does not ship published benchmark numbers. This document tells you *what* to
> measure, *how* to run it, and gives a table shape to record your own results on
> your own hardware. Do not cite these placeholders as vendor performance claims.
